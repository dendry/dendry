...
(function() {
  ...
  var parseFromContent = function(filename, content, callback) {
    ...
    var handleOptionLine = function() {
      ...
      if (option !== null) {
        ...
        options.push({$value:option, $file:filename, $line:i});
      } else {
    ...
    finishCurrentSection();
    return callback(null, {$file:filename, $value:result});
  };
  ...
  var properr = function(property, msg) {
    ...
    if (property.$line === undefined) {
      if (property.$file !== undefined) {
        msg = property.$file+": "+msg;
      }
    } else {
      if (property.$file === undefined) {
