...
(function() {
  ...
  DendryEngine.prototype.__filterByPriority = function(choices,
    ...
    if (maxChoices === null || maxChoices >= totalChoices) {
      ...
      each(candidates, function(choice) {
        choice.selectionPriority = that.state.random.random()/choice.frequency;
      });
  ...
  // Marsaglia, George (July 2003). "Xorshift RNGs". Journal of Statistical
  // Software 8 (14).
