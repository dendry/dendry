...
(function() {
  ...
  UserInterface.prototype.signal = function(signal) {};
  ...
  DendryEngine.prototype.displaySceneContent = function() {
    ...
    if (scene.signal !== undefined) this.ui.signal(scene.signal);
    ...
    objEach(this.game.qualities, function(id, quality) {
      ...
      if (needsAccessors) {
        ...
        Q.__defineSetter__(id, function(value) {
          ...
          if (signal !== undefined && value !== _Q[id]) that.ui.signal(signal);
          _Q[id] = value;
        });
      }
